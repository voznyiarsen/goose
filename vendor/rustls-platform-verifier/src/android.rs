...
/// Whether the platform verifier has been initialized with an Android
/// [`Context`](https://developer.android.com/reference/android/content/Context).
///
/// When this returns `false` (for example in Termux, where goose runs as a
/// standalone native binary without a JVM), the platform verifier cannot be
/// used and callers should fall back to a bundled static root store.
